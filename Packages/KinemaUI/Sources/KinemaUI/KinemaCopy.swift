...
public enum KinemaCopy {
    ...
    public static let playbillTimeline = "My Programme"
    ...
    public static let playbillAutoScrobbleSubtitle = "Identify titles when playback begins, then log them after the completion threshold."
    ...
    public static let playbillTimelineEmptyTitle = "Your programme is empty"
    public static let playbillTimelineEmptyMessage = "Track a series or log a film to see what’s up next and the story of what you watched."
